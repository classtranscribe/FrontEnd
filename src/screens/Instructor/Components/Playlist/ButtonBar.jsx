...
import { setup, mediaControl, plControl, connectWithRedux, ORD_T_MEDIA } from '../../Utils';
          ...
          <div className="ct-btn-group ct-d-r-center-v">
            <Button.Group>
              <Popup
                inverted
                basic
                content={hasSelectedVideos ? 'Unselect All' : 'Select All'}
                trigger={
                  <div>
                    <Button
                      uppercase
                      ...
                      color={selectedAll ? 'black' : hasSelectedVideos ? '' : 'transparent'}
                      // text="Select All"
              ...
              />
              <Button uppercase text="Cancel" color="transparent" onClick={handleCancelSelect} />
            </Button.Group>
          </div>
        ) : (
          <div className="ct-btn-group ct-d-r-center-v">
...
export default connectWithRedux(ButtonBar, ['isSelectingVideos', 'selectedVideos', 'playlist']);
