...
function PlaylistIdentifier({ sourceType = 2, url, setUrl }) {
            ...
            <Grid.Row className="ct-a-fade-in">
              <Grid.Column>
                <CTForm
                  ...
                  onChange={setIndentifier}
                  info={
                    <InfoIcon header="YouTube Playlist URL Example" content={exampleYoutubeURL} />
                  }
                />
              </Grid.Column>
            </Grid.Row>
            ...
            <Grid.Row className="ct-a-fade-in">
              <Grid.Column>
                <CTForm
                  ...
                  onChange={setIndentifier}
                  info={
                    <InfoIcon header="Kaltura Channel URL Example" content={exampleKalturaBUL} />
                  }
                />
              </Grid.Column>
            </Grid.Row>
            ...
            <Grid.Row className="ct-a-fade-in">
              <Grid.Column>
                <CTForm
                  ...
                  value={url}
                  onChange={setIndentifier}
                  info={<InfoIcon header="Box Folder URL Example" content={exampleBoxURL} />}
                />
              </Grid.Column>
            </Grid.Row>
          </Grid>
