...
function LiveTestWithRedux(props) {
  ...
  const m3u8Url =
    'https://cdnapisec.kaltura.com/p/0/sp/0/playManifest/entryId/1_j82of7xw/format/applehttp/protocol/https/flavorParamId/manifest.m3u8';
  ...
  const media = {
    ...
    mediaName: meetingName
      ? meetingName
      : 'BOT Meeting Live Stream' /* TODO: Pull out titles from somewhere, hls doesn't have titles */,
  };
    ...
    <div>
      ...
      <div style={{ width: '100%', height: iframesrc ? '75%' : '100%', position: 'absolute' }}>
        {isIOS ? (
          ...
          <CTPlayer fill defaultOpenCC hideWrapperOnMouseLeave allowTwoScreen media={media} />
        )}
      </div>
      {iframesrc && (
        <iframe
