 ...
 */
 ...
 const ClassTranscribePlayerNew = (props) => {
   ...
   const { transView, muted, volume, playbackrate, openCC, brightness } = props;
 ...
 export const ClassTranscribePlayer = connect(({ watch: {
   ...
   transView, muted, volume, playbackrate, openCC,brightness
 }, loading }) => ({
   media, mode, isSwitched, isFullscreen, embedded, transView, muted, volume, playbackrate, openCC, brightness
