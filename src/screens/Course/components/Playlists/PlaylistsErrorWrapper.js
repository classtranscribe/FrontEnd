...
export default function PlaylistsErrorWrapper({ accessType = 0 }) {
  return (
          ...
          <>
            {accessType === 2 ? ( // Students Only
              <p className="text-muted text-center">
                Sorry, you do not have the access to this course. Please ask your instructors for
                permissions.
              </p>
            ) : accessType === 3 ? ( // University Only
              <p className="text-muted text-center">
                Sorry, this course is only available for students of this university. Please login
                with an email account of this particular university.
              </p>
            ) : (
              <p className="text-muted text-center">
