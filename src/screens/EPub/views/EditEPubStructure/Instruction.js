    ...
    <EPubInstruction expanded={expanded} onToggle={onToggle} title="INSTRUCTIONS">
      <div>
        <CTParagraph>
          ...
          generate an initial layout of your I-Note chapters. Each chapter can be further{' '}
          <b>subdivided</b> into sub-chapters.
        </CTParagraph>
        <CTParagraph>
          After building the structure of your I-Note, proceed to the <b>Edit Chapters Mode</b> to
          modify the contents and images of your I-Note chapters.
        </CTParagraph>
