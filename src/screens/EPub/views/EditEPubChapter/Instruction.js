    ...
    <EPubInstruction title="INSTRUCTIONS">
      <div>
        ...
        <CTParagraph indent="0">
          You can edit the text blocks using Markdown, easy-to-use markup language you can use to format your content. 
          You can create tables, insert links, or embed mathematical equations with it. Learn more at
          <a target="_blank" href="https://www.markdownguide.org/"> www.markdownguide.org</a>.
        </CTParagraph>
        <h5>Insert images</h5>
        <CTParagraph>
