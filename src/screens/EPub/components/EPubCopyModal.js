  ...
  return (
    ...
    >
      <CTFragment role="form" onSubmit={elem.preventDefault}>
        ...
        <CTFormHelp title="Copy I-Notes with a different language">
          When copying this I-Notes with a different language,
...

        {
          ...
          <CTFormRow>
            <CTCheckbox
              ...
              helpText="Initialize new I-Notes with current chapter structure based on timestamps."
            />
          </CTFormRow>
        }
      </CTFragment>
