...
const guides = [
  ...
  },
  {
    ...
    description:
      'There are many keyboard shortcuts for you to quickly manage your I-Notes file, click the "keyboard" icon button to explore!',
  },
  {
    element: '#ct-epb-download-dropdown',
    header: '3/3. Download Options',
    description: 'You can download your I-Notes book in many formats, such as .epub, .pdf or HTML scripts.',
  },
];
