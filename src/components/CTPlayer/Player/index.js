...
import { ErrorWrapper, ClassTranscribePlayer } from 'screens/Watch/Components';
...
function Player(props) {
  ...
  if (isFullscreen) {
    return (
      <div className="ctp ct-player-con-fullscreen" onKeyDown={onKeyDown} tabIndex="0">
        <div className="ctp ct-player lg fill">
...
export default connect(({ watch: { error, isFullscreen } }) => ({
  error,
  isFullscreen,
}))(Player);
