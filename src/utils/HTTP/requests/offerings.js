...
export function deleteInstructorsFromOffering(offeringId, emails) {
    return cthttp.delete(`UserOfferings/DeleteUserFromOffering/${offeringId}/Instructor`, { data: emails })
}

export function deleteStudentsFromOffering(offeringId, emails) {
    return cthttp.delete(`UserOfferings/DeleteUserFromOffering/${offeringId}/Student`, { data: emails })
}
