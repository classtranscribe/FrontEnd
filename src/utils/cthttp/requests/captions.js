...
export function captionUpVote(id) { // captionId
    return cthttp.post('Captions/UpVote', null, { params: { id } })
}

export function captionCancelUpVote(id) { // captionId
    return cthttp.post('Captions/CancelUpVote', null, { params: { id } })
}

export function captionDownVote(id) { // captionId
    return cthttp.post('Captions/DownVote', null, { params: { id } })
}

export function captionCancelDownVote(id) { // captionId
