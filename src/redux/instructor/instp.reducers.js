...
const instpReducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case SET_IS_EDITING_OFFERING:
      return { ...state, isEditingOffering: value };
    case SET_IS_VIEWING_ANALYTICS:
      return { ...state, isViewingAnalytics: value };
    ...
    case SET_IS_SELECTING_VIDEOS:
      return { ...state, isSelectingVideos: value };
    case SET_SELECTED_VIDEOS:
      return { ...state, selectedVideos: value };
