...
import { CTP_LOADING, MODAL_HIDE, SEARCH_INIT } from '../../screens/Watch/Utils';
...
const watchReducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case SET_OPENCC:
      return { ...state, openCC: value };
    case SET_OPENAD:
      return { ...state, openAD: value };

    // Settings
    case SET_MODE:
      return { ...state, mode: value };
    case SET_TRANS_VIEW:
      return { ...state, transView: value };
    case SET_MENU:
    ...
    case SET_BUFFERED_TIME:
      return { ...state, bufferedTime: value };
    case SET_DURATION:
      return { ...state, duration: value };
    case SET_PLAYBACKRATE:
      return { ...state, playbackrate: value };
    case SET_VOLUME:
      return { ...state, volume: value };
    case SET_MUTE:
      return { ...state, muted: value };
    case SWITCH_SCREEN:
      return { ...state, isSwitched: value };
    case SET_FULLSCREEN:
      return { ...state, isFullscreen: value };
    case SET_CTP_PRI_E:
      return { ...state, ctpPriEvent: value };
    case SET_CTP_SEC_E:
      return { ...state, ctpSecEvent: value };

    // CC Options
    case CC_COLOR:
      return { ...state, cc_color: value };
    case CC_BG:
      return { ...state, cc_bg: value };
    case CC_OPACITY:
      return { ...state, cc_opacity: value };
    case CC_SIZE:
      return { ...state, cc_size: value };
    case CC_FONT:
      return { ...state, cc_font: value };
    case CC_POSITION:
      return { ...state, cc_position: value };
